...
public class RedBaoService extends AccessibilityService {
    ...
    private static final String RedBaoPackage    = "com.tencent.mm:id/a4w";//红包的资源ID
    private static final String BtnKai           = "com.tencent.mm:id/bi3";//按钮“开”的资源ID
    private static final String BtnBack          = "com.tencent.mm:id/gv"; //回退键的资源ID
